    ...
    public partial class FormConnexion : Form 
    {
        ...
        private void tbIdGerant_Leave(object sender, EventArgs e)
        {
            if (tbIdGerant.Text =="")
            {
                ...
                tbIdGerant.ForeColor = Color.DarkGray;
                pnlUnderIdGerant.BackColor = Color.DarkGray;
            }
        }
        ...
        private void tbMdpGerant_Leave(object sender, EventArgs e)
        {
            if (tbMdpGerant.Text =="")
            {
                ...
                tbMdpGerant.ForeColor = Color.DarkGray;
                pnlUnderMdpGerant.BackColor = Color.DarkGray;
            }
        }
